...
public class HomePage {
    ...
    @FindBy(xpath = "//div[./h2[contains(text(), 'nearly 40 years')]]//a[.//span[contains(text(), 'Book')]]")
    private WebElement imageBookNowButton;
    @FindBy(xpath = "//div[./h2[contains(text(), 'nearly 40 years')]]//a[.//span[contains(@id,'phoneNumber')]]")
