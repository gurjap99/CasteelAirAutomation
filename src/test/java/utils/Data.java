...
public class Data {
    public static final String BASE_URL = "https://test.casteelair.com/";
    ...
    public static final String WHY_HORIZON_URL = BASE_URL + "about-us/why-casteel";
    ...
    public static final String[] FOOTER_MENU_ITEMS = {"Services", "Heating & Cooling", "Plumbing", "Electrical",
            "Quick Links", "Learn", "Financing", "Membership", "Offers & Rebates", "About Us", "Why Casteel", "Reviews",
            "Work With Us", "Contact Us"};

    public static final String STATIC_PHONE_NUMBER = "1-770-852-8504";
    ...
    static {
        ...
        categoryServiceMap.put("About Us", new ArrayList<>(Arrays.asList(
                "Why Casteel", "Reviews", "Work With Us", "Contact Us", "In the Community", "Preferred Brands"
        )));
    }
}
