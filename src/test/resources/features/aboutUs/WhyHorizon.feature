Feature: Casteel Air About Us Why casteel Page tests

  @Regression
  Scenario: Open About Us Why casteel page and verify Book Now, Call buttons:
    Given I navigate to "https://test.casteelair.com"
    When I Click on About Us
    When I click on "Why Casteel" button in category header submenu
