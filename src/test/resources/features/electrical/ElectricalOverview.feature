Feature: Casteel Air Electrical Overview Page tests
  ...
  Scenario: Validate Image Call and Book Now buttons on Electrical overview page
    ...
    When I Click on Electrical
    When I click on Overview button in "Electrical" header submenu
    When I click on Book Now button in Image on "Casteel Air electrical" Page
    Then I should see Book Online Now Window and close it
    When I click on Phone Number in Image on "Casteel Air electrical" Page
    Then I can verify Phone call popup