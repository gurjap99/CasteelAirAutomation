Feature: Casteel Air Heating & Cooling Overview Page tests
  ...
  Scenario: Validate Image Call and Book Now buttons on Heating & Cooling overview page
    ...
    When I Click on Heating & Cooling
    When I click on Overview button in "Heating & Cooling" header submenu
    When I click on Book Now button in Image on "Casteel Air heating and cooling" Page
    Then I should see Book Online Now Window and close it
    When I click on Phone Number in Image on "Casteel Air heating and cooling" Page
    Then I can verify Phone call popup
