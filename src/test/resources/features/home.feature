Feature: Casteel Air home page tests
  ...
  Scenario: Validate Header Sub Menu Order
    ...
    Then I should see new page with URL "https://test.casteelair.com/learning-hub"
  ...
  Scenario: Validate visibility of static phone number in home page
    Given I navigate to "https://test.casteelair.com" with javaScript turned off, then I visible phone numbers should be same as static phone number

  @Regression
  Scenario: Validate Zipcode is getting updated properly in homepage
    Given I navigate to "https://test.casteelair.com"
    When I update Zipcode "30066" using eyebrow button
    Then "Your home is in our service area!" appears, "30066" Zipcode gets updates properly, Map and map zipcode input disappears
...
#    Then I can close customer care modal
  ...
  Scenario: Validate Map Zipcode Input and Book Now
    Given I navigate to "https://test.casteelair.com"
    When I update Zipcode "30066" using map zipcode input
    Then "Your home is in our service area!" appears, Zip code "30066" should be update in the home page
  ...
  Scenario: Verify footer Privacy Policy and ADA Notice links
    ...
    Then it navigates to "https://test.casteelair.com/privacy-policy"
    When I click on ADA Notice Link
    Then it navigates to "https://test.casteelair.com/ada-notice"
